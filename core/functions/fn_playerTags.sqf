...
_masks = LIFE_SETTINGS(getArray,"clothing_masks");
{
 ...
 case 13: {"L. Polizeidirektor"};
 case 14: {"Polizeivizepräsident"};
 ...
 case (!isNil {(_x getVariable "medrank")} && side _x == independent): {format["<t size='1.2' color='#FF0000'>%1</t><t size='1.2' color='#FF0000'>%3<br/></t>%2",switch ((_x getVariable "medrank")) do {
   ...
   case 6: {"Brandmeisteranwärter"};
   case 7: {"Brandmeister"};
   case 8: {"Oberbrandmeister"};
   case 9: {"Brandrat"};
   case 10: {"Brandoberrat"};
   case 11: {"Branddirektor"};
   case 12: {"Leitender Branddirektor"};
   default {"Praktikant"};
 },_x getVariable ["realname",name _x]]};

 case (!isNil {(_x getVariable "adacrank")} && side _x == east): {format["<t size='1.2' color='#FF0000'>%1</t><t size='1.2' color='#FF0000'>%3<br/></t>%2",switch ((_x getVariable "adacrank")) do {
   case 1: {"Praktikant"};
   case 2: {"Mechatroniker - Azubi"};
   case 3: {"Mechatroniker - Geselle"};
   case 4: {"Mechatroniker - Meister"};
   default {"Praktikant"};
 },_x getVariable ["realname",name _x]]};
 default {
