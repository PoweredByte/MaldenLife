...
define iconID 78000# define scale 0.8
            ...
            if (count _sPos > 1 && {
                ...
                _text =
                    switch (true) do {
                        ...
                        case (!isNil {
                            (_x getVariable "rank")
                                ...
                                format["<t size='1.2' color='#318CE7'>%1</t><t size='1.2' color='#318CE7'>%3<br/></t>%2",
                        ...
                        case (!isNil {
                            (_x getVariable "medrank")
                        } && side _x == independent):{
                                format["<t size='1.2' color='#FF0000'>%1</t><t size='1.2' color='#FF0000'>%3<br/></t>%2",
                    ...
                    if (_x getVariable["speaking", false]) then {
                        _text = "<t color='#12cc12'>[Spricht] " + _text;
                    };
