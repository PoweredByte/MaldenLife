...
/*
if (_curTarget getVariable ["restrained",false] isEqualTo 0) then {
    { _x ctrlShow false; } forEach [_Btn1,_Btn4,_Btn6,_Btn7];
};

if (playerSide isEqualTo civilian && (_curTarget getVariable ["restrained",false] isEqualTo 0) exitWith {["Das Ziel ist nicht festgenommen!","ZionHost-System","red",false] call MSG_fnc_handle;};
