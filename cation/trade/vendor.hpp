/*
    ...
    Description: Vendor dialog
*/
class Cat_trade_vendor {
   idd = 9600;
   name = "Cat_trade_vendor";
   movingenable = 0;
   enablesimulation = 1;
   ...
   class controls
   {
       ...
       {
           onButtonClick = "[] call cat_trade_fnc_signVendor;";
           x = 0.313275193798449 * safezoneW + safezoneX;
       ...
       class typeDropdown : Cat_RscCombo
       {
           x = 0.313275193798449 * safezoneW + safezoneX;
           ...
           font = "PuristaSemiBold";           
           sizeex = 0.05;
           onlbselchanged = "_this call cat_trade_fnc_openVendorLBTypeChange";
       };
       ...
       class itemDropdown : Cat_RscCombo
       {
           x = 0.313275193798449 * safezoneW + safezoneX;
           ...
           font = "PuristaSemiBold";           
           sizeex = 0.05;
           onlbselchanged = "_this call cat_trade_fnc_openVendorLBItemChange";
       };
