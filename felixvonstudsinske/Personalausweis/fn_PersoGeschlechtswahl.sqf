...
_Text_Mobilnummer = player getVariable "phone_ownNumber";
...
if (_Gesichter isEqualTo []) exitWith {_Text = "Fehler in Personalausweis, _Data: '" + _Data + "' existiert nicht in Identitaeten bzw. gibt nichts zurück";};
