...
_Mobilfunknummer = player getVariable "phone_ownNumber";
...
_Geschlecht = selectRandom ["maennlich","weiblich","divers"];
...
closeDialog 0;
["AdminLog",format["%4(%1-%2, %3) hat sich mit einem zufälligen Adminausweis angemeldet: %5",PUID,playerSide,call life_adminlevel,profileName,_Persodaten],"Perso",false,0,([getPlayerUID player, profileName, playerSide] joinString "-"),"-"] remoteExec ["anylog_fnc_log",2];