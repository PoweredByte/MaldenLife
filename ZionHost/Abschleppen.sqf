...
if(!isDedicated) then {
    [] spawn {
        while {true} do {
            if(!isNull player && isPlayer player && playerSide in [west,independent,east]) then {
