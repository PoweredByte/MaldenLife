...
Params:
 ...
 Example Uses:
 ["Welcome to CQC"] call ZionHost_fnc_notifications;
 ["Tactical View is Disabled", "warning"] call ZionHost_fnc_notifications;
 ["Cant Spawn Vehicle", "error", 50] call ZionHost_fnc_notifications;
*/
